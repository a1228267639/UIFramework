...
public class UIScrollbarEditor : UnityEditor.UI.ScrollbarEditor
{
    ...
    {
        base.OnInspectorGUI();
        UIScrollbar inspectorObj = (UIScrollbar)target;
    ...
    [MenuItem("GameObject/UIFramework/UI Scrollbar", priority = 8)]
    public static void UISlider()
    {
        CreateUIPaefabTools.CreateUIPaefab(@"Assets\UIFramework\Base\Prefabs\UIPanel\UIScrollbar.prefab");
    }
}
