...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public Vector2 ItemSnapPivot
        {
            get
            {
                return mItemSnapPivot;
            }
            set
            {
                mItemSnapPivot = value;
            }
        }
        public Vector2 ViewPortSnapPivot
        {
            get
            {
                return mViewPortSnapPivot;
            }
            set
            {
                mViewPortSnapPivot = value;
            }
        }
